...
% and whistles, select "baseline" as an extension and 'myopic' as info
% assumption, and make sure to set rho=0 in parameters.
...
extension = 'Epi'; % Epi, pil or il or baseline
%%%%%%%%%%%%%%%%
...
for t=1:nd % for the two diff times of imposing the shock
    ...
    figname = [this_code, '_', 'RIR_LH_' shocknames{s}, '_', gain_name, '_gbar_', gbar_val, ...
        '_', extension, '_', info_ass, '_', PLM_name ];
    subplot_names = titles_obs;
    legendnames = {'Learning', 'RE'};
