...
critCEMP=1;
critCUSUM=2;
[x, y] = sim_learn(gx,hx,SIG,T,burnin,e, Aa_LH, Ab_LH, As_LH, param, setp, H, anal, constant_only, dgain, critCEMP);
...
for s=1:n
    ...
    for t=1:T-h
        ...
        [x, y] = sim_learn(gx,hx,SIG,T,burnin,e, Aa_LH, Ab_LH, As_LH, param, setp, H, anal, constant_only, cgain, critCEMP, t, x0);
