...
function [sig ar_rho rho, SigY0] = mom_tab(gx, hx, varshock, var_idx, var_names,varargin)
...
%Stack SigY and SigX for convenience
SigY0 = [SigY0, gx*SigX0; SigX0*gx' SigX0];
SigY1  = blkdiag(SigY1, SigX1);
