...
%% now try to construct and min FEVs by choice of gain gbar
disp('returning here')
tic
...
%% This section just illustrates the concept of a FEV and my 2 concepts of it
return
