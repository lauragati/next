...
% 2 April 2020
function [xsim, ysim, evening_fcst, morning_fcst, FA, FB, FEt_1, shock, diff,phi_seq, k,anchored_when_shock,g_pi] = sim_learnLH_given_seq(gx,hx,eta,T,ndrop,e, Aa, Ab, As, param, PLM, gain,seq, dt, x0)
