...
for t=1:nd % for the two diff times of imposing the shock
    ...
    series(1,:,:) = RIR_Y_EE(:,:,t)';
    series(2,:,:) = iry';
    figname = [this_code, '_', 'RIR_EE_' shocknames{s},'_', PLM_name,'_', gain_name, '_gbar_', gbar_val,'_', todays_date];
    ...
    series(1,:,:) = RIR_Y_LH(:,:,t)';
    series(2,:,:) = iry';
    figname = [this_code, '_', 'RIR_LH_' shocknames{s},'_', PLM_name,'_', gain_name, '_gbar_', gbar_val,'_', todays_date];
    subplot_names = titles_obs;
    legendnames = {'Learning', 'RE'};
