...
[x0, y0, k0, phi0, FA0, FB0, FEt_10, diff0] = sim_learnLH_clean_approx(true_alph,x,param,gx,hx,eta, PLM, gain, T,ndrop,e,knowTR,mpshock);
...
acf_outputs = {Om, Om_boot,ny,p,K, filt_data, lost_periods, true_alph, nk1, nfe};
