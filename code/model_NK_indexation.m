...
% cost-push; and with pi-indexation in NKPC
% 17 Jan 2020
% adapted from model_NK.m

function [fyn, fxn, fypn, fxpn] = model_NK_indexation(param)

%Steady State
[ss, param] = model_NK_indexation_ss(param);
...
f(2) = -PI*(1+bet*gam) +gam*PIL + kapp*XX +bet*PI_p +U; 
