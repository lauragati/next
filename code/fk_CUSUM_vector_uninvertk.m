function [k, om, thet] = fk_CUSUM_vector_uninvertk(param,kt_1,omt_1, thett_1, f)
...
thet = thett_1 + kap*kt_1*(tauhat - thett_1); % this gives you a scalar yo
