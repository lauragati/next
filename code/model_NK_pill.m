...
% cost-push and interest rate smoothing, and lagged inflation in the TR
% 10 Dec 2019
% adapted from model_preston.m

function [fyn, fxn, fypn, fxpn] = model_NK_pill(param)

%Steady State
[ss, param] = model_NK_pill_ss(param);
...
syms RN RN_p IB IB_p U_p U PIL PIL_p PILL PILL_p
syms PI PI_p XX XX_p I I_p 

%Declare X and Y vectors
X  = [RN IB U PIL PILL]; 
XP = [RN_p IB_p U_p PIL_p PILL_p];
