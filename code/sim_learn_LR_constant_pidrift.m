% simulate data from learning model LR learning of just constant, and that
% constant should be only the drift in pi
% 20 sept 2019

function [xsim, ysim, shock, diff,pibar] = sim_learn_LR_constant_pidrift(gx,hx,eta,T,ndrop,e, Aa, Ab, As, param, setp,H, anal)
gbar = param.gbar;
