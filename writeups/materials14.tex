...
\end{align}
\begin{equation}
\hat{\E}_t z_{t+h} =  \bar{z}_{t-1} + bh_x^{h}s_t  \quad \forall h\geq 1 \quad \quad b = g_x \quad \quad \text{PLM} \label{PLM}
\end{equation}
\begin{equation}
...
\begin{itemize}
\item I'm surprised that the all-passive state is unstable.
