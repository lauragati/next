...
In the last alternative specification, I replace both the ten and the one-year ahead CPI inflation expectation with PCE core. The regression equation thus looks identical to Equation (\ref{rolling_reg}) but should clean out the effects of movements in oil prices:
