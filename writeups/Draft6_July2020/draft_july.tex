...
\begin{figure}[h!]
\subfigure[$i(k^{-1})$]{\includegraphics[scale=0.17]{\myFigPath \fignameDiDk}}
\subfigure[$i(\bar{\pi})$]{\includegraphics[scale=0.17]{\myFigPath \fignameDiDpibar}}
...
\begin{figure}[h!]
\subfigure[]{\includegraphics[scale=0.24]{\myFigPath \fignamePEAobsTR}}
\hfill % this is great to intro space between subfigures
\subfigure[]{\includegraphics[scale=0.24]{\myFigPath \fignamePEAobsAnch}}
\caption{}
\label{pea_TCvsTR}
\end{figure}
...
\begin{figure}[h!]
\subfigure[RE]{\includegraphics[scale = 0.14]{\myFigPath \fignameCBlossRE}}
\subfigure[Anchoring]{\includegraphics[scale = 0.14]{\myFigPath \fignameCBlossAnch}}
