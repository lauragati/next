...
\includegraphics[scale=0.21]{\myFigPath \fignameDiDpibar}
...
%  Baseline (lamx=0.05, lami=0)  & $1.8581$  & 1.034 \\  \hline
...
\begin{figure}[h!]
\subfigure[$\lambda_x = 0, \lambda_i = 0$]{\includegraphics[scale = 0.22]{\myFigPath \fignameCBlossnilnil}}
\hfill
\subfigure[$\lambda_x = 1, \lambda_i = 0$]{\includegraphics[scale = 0.22]{\myFigPath \fignameCBlossonenil}}
\subfigure[$\lambda_x = 0, \lambda_i = 1$]{\includegraphics[scale = 0.22]{\myFigPath \fignameCBlossnilone}}
\hfill
\subfigure[$\lambda_x = 1, \lambda_i = 1$]{\includegraphics[scale = 0.22]{\myFigPath \fignameCBlossoneone}}
