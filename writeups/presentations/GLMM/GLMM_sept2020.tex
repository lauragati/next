...
\begin{equation}
\E_t \pi_{t+1} = \textcolor{brownreddark}{\bar{\pi}_{t-1}} + f(shocks)
\end{equation}
...
\begin{equation*}
\bar{\pi}_{t-1} \neq \pi^* \quad \quad \text{and} \quad \quad \bar{\pi}_{t-1} = h(shocks)
\end{equation*}
...
\begin{enumerate}
\item Model of anchoring expectations: key elements

\

\

\item Features of optimal policy under anchoring expectation formation
