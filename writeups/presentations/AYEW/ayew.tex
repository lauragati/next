...
\date[]{Applied Young Economists Webinar (AYEW)  \\
\vspace{0.5cm}
November 17-18, 2020}
...
\begin{equation}
\hat{\E}_t y_{t+1} = \hat{\E}_t \begin{pmatrix}\pi_{t+1} \\ x_{t+1} \\ i_{t+1} \end{pmatrix}  = \begin{pmatrix} \textcolor{brownreddark}{\bar{\pi}_{t-1}} \\ 0 \\ 0 \end{pmatrix} + g h s_t  \label{PLM_fcst_general}
\end{equation}
...
\item Agents estimate $\bar{\pi}_{t-1}$ using observed states and knowledge of (\ref{state})
