...
\begin{figure}[h!]
\subfigure[$\lambda_x = 0, \lambda_i = 0$]{\includegraphics[scale=0.25]{\myFigPath \fignameCBlossnilnil}}
%%\hfill
%\subfigure[$\lambda_x = 1, \lambda_i = 0$]{\includegraphics[scale=0.11]{\myFigPath \fignameCBlossonenil}}
%\subfigure[$\lambda_x = 0, \lambda_i = 1$]{\includegraphics[scale=0.11]{\myFigPath \fignameCBlossnilone}}
%%\hfill
%\subfigure[$\lambda_x = 1, \lambda_i = 1$]{\includegraphics[scale=0.11]{\myFigPath \fignameCBlossoneone}}
\caption{CB loss as a function of $\psi_{\pi}$}
\end{figure} % Materials 35
