...
\textcolor{blue}{Intertemporal tradeoff from current level and change of the gain } \\

\

\

\textcolor{mygreen}{Intertemporal tradeoff from future expected levels and changes of the gain}
}
\end{frame}
%%%%%%%%%%%%%%%%%%
...
\item Would explain deviations from Taylor rule
