...
\only<1>{\textcolor{brownreddark}{Intratemporal tradeoffs in RE (discretion)} \\}

\

\

\only<2>{\textcolor{brownreddark}{Postpone current tradeoff to future as long as gain $>$ 0} \\}

\

\

\only<3>{\textcolor{brownreddark}{Extent to which can postpone depends on not unanchoring too much in future}}
