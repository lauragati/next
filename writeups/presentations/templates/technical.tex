...
%%%%%%%%%%%%%%%%%%%%
% All the pre-defined stuff was updated 6 Aug 2020, and corresponds to the July Draft, version 30 July 2020.
...
\caption{Unanchoring as a function of forecast errors in inflation (pp)}
\label{epi}
\end{figure}
...
%\hfill
\subfigure[Optimal policy]{\includegraphics[scale=0.125]{\myFigPath \fignamePEAobsAnch}}
\hfill
\subfigure[Taylor rule]{\includegraphics[scale=0.148]{\myFigPath \fignamePEAobsTR}}
...
\begin{figure}[h!]
\subfigure[$\lambda_x = 0, \lambda_i = 0$]{\includegraphics[scale=0.11]{\myFigPath \fignameCBlossnilnil}}
%\hfill
