...
\includegraphics[scale = 0.24]{\myFigPath \fignameRegressionPlot}
\label{pi_epi}
\end{figure}
...
$\hat{\beta}_1 = 0.06 \quad $  (p-value: 0.000017)

\


1 pp forecast error $\rightarrow$ 6 bp revision in long-run expectations
\end{frame}
%%%%%%%%%%%%%%%%%
