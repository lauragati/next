...
%%%%%%% Slide %%%%%%  	
\begin{frame}
	\frametitle{Long-run expectations can unanchor}\label{anchoring_simple}


\begin{equation}
\bar{\pi}_{t}  =\bar{\pi}_{t-1} + \textcolor{brownreddark}{k_t} \; fe_{t|t-1}
\end{equation}
...
$k_t = \textcolor{brownreddark}{\mathbf{g}(fe_{t|t-1})}$: anchoring function \hfill \hyperlink{expectations_details}{\beamergotobutton{Details on model of expectations}}
\pause
\begin{equation}
...
\begin{figure}[h!]
\includegraphics[scale=0.28]{\myFigPath \fignameCBlossnilnil}
...
%%%%%%%% Slide %%%%%%
\begin{frame}
	\frametitle{Expectations: $\hat{\E}$ instead of $\E$}\label{expectations_details}
...
\vfill 
\hyperlink{anchoring_simple}{\beamerreturnbutton{Return}}	
