...
\subsection{Odd number of breakpoints (5)}
...
\clearpage
\subsection{Even number of breakpoints (6)}
...
\begin{figure}[h!]
\subfigure[$\alpha^{true}, \alpha_0, mean(\hat{\alpha}), \colorbox{yellow}{5 breakpoints, uniformly spaced}$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath command_GMM_LOMgain_univariate_alphas_resnorm_307_nfe_5_14_Jul_2020}}
\hfill
\subfigure[Autocovariogram]{\includegraphics[scale=\mySmallerFigScale]{\myFigPath command_GMM_LOMgain_univariate_autocovariogram_sim_nfe_5_resnorm_307_14_Jul_2020}}
\subfigure[$\alpha^{true}, \alpha_0, mean(\hat{\alpha}), \colorbox{yellow}{7 breakpoints, uniformly spaced}$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath command_GMM_LOMgain_univariate_alphas_resnorm_300_nfe_7_14_Jul_2020}}
\hfill
\subfigure[Autocovariogram]{\includegraphics[scale=\mySmallerFigScale]{\myFigPath command_GMM_LOMgain_univariate_autocovariogram_sim_nfe_7_resnorm_300_14_Jul_2020}}
\subfigure[$\alpha^{true}, \alpha_0, mean(\hat{\alpha}), \colorbox{yellow}{5 breakpoints, concentrated around 0} $]{\includegraphics[scale=\myTinyFigScale]{\myFigPath placeholder}}
\hfill
