...
\begin{figure}[h!]
\subfigure[$\alpha^{true}, \alpha_0, mean(\hat{\alpha}), \colorbox{yellow}{N=1000}$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath command_GMM_LOMgain_univariate_alphas_resnorm_153_09_Jul_2020}}
\hfill
\subfigure[Autocovariogram]{\includegraphics[scale=\mySmallerFigScale]{\myFigPath command_GMM_LOMgain_univariate_autocovariogram_sim_nfe_5_resnorm_153_09_Jul_2020}}
%\subfigure[$\alpha^{true}, \alpha_0, mean(\hat{\alpha}), \colorbox{yellow}{N=2000}$]{\includegraphics[scale=\mySmallFigScale]{\myFigPath command_GMM_LOMgain_univariate_alphas_resnorm_153_N_2000_09_Jul_2020}}
%\hfill
%\subfigure[Autocovariogram]{\includegraphics[scale=\mySmallFigScale]{\myFigPath command_GMM_LOMgain_univariate_autocovariogram_sim_nfe_5_resnorm_153_N_2000_09_Jul_2020}}
%\subfigure[$\alpha^{true}, \alpha_0, mean(\hat{\alpha}), \colorbox{yellow}{N=10000} $]{\includegraphics[scale=\mySmallFigScale]{\myFigPath command_GMM_LOMgain_univariate_alphas_resnorm_110_10_Jul_2020}}
%\hfill
%\subfigure[Autocovariogram]{\includegraphics[scale=\mySmallFigScale]{\myFigPath command_GMM_LOMgain_univariate_autocovariogram_sim_nfe_5_resnorm_110_10_Jul_2020}}
\caption{Mean estimates for increasing $N$, imposing convexity with weight 10M, truth with $nfe=5, fe \in(-2,2)$}
\end{figure}
...
\begin{figure}[h!]
\subfigure[$\alpha^{true}, \alpha_0, mean(\hat{\alpha}), \colorbox{yellow}{N=100} $]{\includegraphics[scale=\myTinyFigScale]{\myFigPath command_GMM_LOMgain_univariate_alphas_resnorm_643_13_Jul_2020}}
\hfill
...
%\subfigure[$\alpha^{true}, \alpha_0, mean(\hat{\alpha}), \colorbox{yellow}{N=1000} $]{\includegraphics[scale=\myTinyFigScale]{\myFigPath command_GMM_LOMgain_univariate_alphas_resnorm_149_13_Jul_2020}}
%\hfill
...
%\subfigure[$\alpha^{true}, \alpha_0, mean(\hat{\alpha}), \colorbox{yellow}{N=10000}$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath command_GMM_LOMgain_univariate_alphas_resnorm_147_13_Jul_2020}}
%\hfill
...
\clearpage
\subsection{Finer grid in the zero neighborhood}
\begin{figure}[h!]
\subfigure[$\alpha^{true}, \alpha_0, mean(\hat{\alpha}), \colorbox{yellow}{uniformly spaced}$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath placeholder}}
\hfill
\subfigure[Autocovariogram]{\includegraphics[scale=\mySmallerFigScale]{\myFigPath placeholder}}

\subfigure[$\alpha^{true}, \alpha_0, mean(\hat{\alpha}), \colorbox{yellow}{concentrated around 0} $]{\includegraphics[scale=\myTinyFigScale]{\myFigPath placeholder}}
\hfill
\subfigure[Autocovariogram]{\includegraphics[scale=\mySmallerFigScale]{\myFigPath placeholder}}
...
\caption{Mean estimates for $N=100$, breakpoints concentrated around 0, 0 at 0 imposed with weight 1000, imposing convexity with variable weight, truth with $nfe=5, fe \in(-2,2)$}
\end{figure}
...
\begin{figure}[h!]
\subfigure[$\bar{\hat{\alpha}}=(0.2388;    0.0082;    0.001;    0.007;    0.2155)$, $\colorbox{yellow}{N=100} $]{\includegraphics[scale=\myTinyFigScale]{\myFigPath command_GMM_LOMgain_univariate_alph_opt_resnorm_117_nfe_5_15_Jul_2020}}
\hfill
\subfigure[Autocovariogram at an average of the $N$ shock histories]{\includegraphics[scale=\mySmallerFigScale]{\myFigPath command_GMM_LOMgain_univariate_autocovariogram_nfe_5_loss_273_gridspacing_uneven_Wdiffs2_10000_Wmid_1000_15_Jul_2020}}
\caption{Mean estimated parameters over the cross-section of size $N$, 5 breakpoints, convexity imposed with weight 10K, points unevenly spaced (denser at 0), 0 at 0 imposed with weight 1000, mean moment not imposed}
\end{figure}
