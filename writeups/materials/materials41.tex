...
\caption{Not using 1-step ahead forecasts of inflation, estimate mean moments once, imposing convexity with weight 100K, w/o measurement error, truth with $nfe=5, fe \in(-2,2)$, \colorbox{yellow}{taking square root of elements of $W$} (This is to be compared with the default Nsimulations figure.)}
\end{figure}
