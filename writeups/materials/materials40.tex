...
\caption{Cross-sectional means when varying $\alpha_{1,5}, N=100$, $\alpha=(0.05,0.025,0,0.025,0.05)$, $nfe=5, fe \in(-2,2)$, \texttt{rng(1)}}
\end{figure}
...
\caption{Cross-sectional means when varying $\alpha_{2,4}, N=100$, $\alpha=(0.05,0.025,0,0.025,0.05)$, $nfe=5, fe \in(-2,2)$, \texttt{rng(1)}}
\end{figure}
...
\caption{Cross-sectional means when varying $\alpha_{3}, N=100$, $\alpha=(0.05,0.025,0,0.025,0.05)$, $nfe=5, fe \in(-2,2)$, \texttt{rng(1)}}
\end{figure}
