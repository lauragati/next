...
\begin{figure}[h!]
\subfigure[Optimal policy: PEA vs VFI]{\includegraphics[scale=\mySmallFigScale]{\myFigPath compare_value_pea_results_approx_value_outputs_approx30_Jun_2020_10_19_45_pea_outputs_approx30_Jun_2020_09_39_12_pretty}}
\hfill
\subfigure[Observables under optimal policy conditional on a history of shocks]{\includegraphics[scale=\mySmallerFigScale]{\myFigPath implement_anchTC_obs_approx30_Jun_2020}}
\subfigure[Gain under optimal policy conditional on a history of shocks]{\includegraphics[scale=\mySmallerFigScale]{\myFigPath implement_anchTC_invgain30_Jun_2020}}
...
\begin{figure}[h!]
\includegraphics[scale=\mySmallFigScale]{\myFigPath analyze_opt_policy_ip30_Jun_2020}
...
\begin{figure}[h!]
\subfigure[$\lambda_x = 0, \lambda_i = 0$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath plot_sim_loss_approx_pretty_losses_again_critsmooth_constant_only_pi_only_params_psi_pi_1_5_psi_x_0_gbar_0_145_lamx_0_lami_0_2020_07_01}}
\hfill
\subfigure[$\lambda_x = 1, \lambda_i = 0$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath plot_sim_loss_approx_pretty_losses_again_critsmooth_constant_only_pi_only_params_psi_pi_1_5_psi_x_0_gbar_0_145_lamx_1_lami_0_2020_07_01}}
\subfigure[$\lambda_x = 0, \lambda_i = 1$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath plot_sim_loss_approx_pretty_losses_again_critsmooth_constant_only_pi_only_params_psi_pi_1_5_psi_x_0_gbar_0_145_lamx_0_lami_1_2020_07_01}}
\hfill
\subfigure[$\lambda_x = 1, \lambda_i = 1$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath plot_sim_loss_approx_pretty_losses_again_critsmooth_constant_only_pi_only_params_psi_pi_1_5_psi_x_0_gbar_0_145_lamx_1_lami_1_2020_07_01}}
...
%  $\psi_{x} =1$  & $\infty$  & 1 \\  \hline
 $\lambda_x =1, \lambda_i =0 $ &  2.1042 & 1.2674 \\  \hline
 $\lambda_x =0, \lambda_i =1 $ & 1.1   &  1 \\  \hline
  $\lambda_x =1, \lambda_i =1 $ &1.6092 &1.0539   \\  \hline
\end{tabular}     
      \caption{Optimal coefficient on inflation, RE against anchoring for alternative parameters}  \label{par_opt}
 \end{table}
\end{center}

Wait: calibration issues:
\begin{itemize}
\item $\alpha=$? So far I've used 0.5.
\item I've used $\kappa = \frac{(1-\alpha\beta)}{\alpha} \zeta$ where I should have used $\kappa = \frac{(1-\alpha)(1-\alpha\beta)}{\alpha} \zeta$. $\zeta = \frac{\omega + \sigma^{-1}}{1+\omega\beta}$
\end{itemize}
