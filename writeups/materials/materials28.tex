...
\begin{figure}[h!]
\subfigure[Value function]{\includegraphics[scale=0.5]{\myFigPath vfi_discrete_valuefun}}
\subfigure[Decision rules]{\includegraphics[scale=0.5]{\myFigPath vfi_discrete_decisions}}
\end{figure}
\subsection{Optimal growth - value function iteration with Chebyshev polynomial interpolation}
\begin{figure}[h!]
\subfigure[Value function]{\includegraphics[scale=0.5]{\myFigPath vfi_cheby_valuefun}}
\subfigure[Decision rules]{\includegraphics[scale=0.5]{\myFigPath vfi_cheby_decisions}}
\end{figure}
\newpage
\subsection{Optimal growth - value function iteration with cubic spline interpolation}
\begin{figure}[h!]
\subfigure[Value function]{\includegraphics[scale=0.5]{\myFigPath vfi_spline_valuefun}}
\subfigure[Decision rules]{\includegraphics[scale=0.5]{\myFigPath vfi_spline_decisions}}
\end{figure}
\subsection{Optimal growth - value function iteration with piecewise cubic Hermite interpolation (shape-preserving)}
\begin{figure}[h!]
\subfigure[Value function]{\includegraphics[scale=0.5]{\myFigPath vfi_pchip_valuefun}}
\subfigure[Decision rules]{\includegraphics[scale=0.5]{\myFigPath vfi_pchip_decisions}}
\end{figure}
\newpage
\subsection{Optimal growth - stochastic value function iteration with bivariate tech shock, discretized}
\begin{figure}[h!]
\subfigure[Value function]{\includegraphics[scale=0.5]{\myFigPath vfi_stoch_valuefun}}
\subfigure[Decision rules]{\includegraphics[scale=0.5]{\myFigPath vfi_stoch_decisions}}
\end{figure}
