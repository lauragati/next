...
\begin{figure}[h!]
\subfigure[$k^{-1}_t$ as a function of $k^{-1}_{t-1}$ and $fe_{t|t-1}$ given $\hat{\alpha}^{true}$]{\includegraphics[scale=\mySmallFigScale]{\myFigPath command_acf_sim_data_true_relationship_21_Jun_2020}}
\hfill
\subfigure[A simulated history of $k^{-1}_t$ given $\hat{\alpha}^{true}$]{\includegraphics[scale=\mySmallFigScale]{\myFigPath command_acf_sim_data_true_gain_sim_constant_only_pi_only_21_Jun_2020}}
