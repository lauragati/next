...
\item Target criterion relies on the assumption $k_t^{-1} =\mathbf{g}(fe)$. Need a 1D estimate to implement the target criterion.
\end{enumerate}
...
\clearpage
\section{Estimating $\alpha$ on simulated data}

\begin{figure}[h!]
\subfigure[$k^{-1}_t$ as a function of $k^{-1}_{t-1}$ and $fe_{t|t-1}$ given $\hat{\alpha}^{true}$]{\includegraphics[scale=\mySmallFigScale]{\myFigPath true_relationship18_Jun_2020}}
\hfill
\subfigure[A simulated history of $k^{-1}_t$ given $\hat{\alpha}^{true}$]{\includegraphics[scale=\mySmallFigScale]{\myFigPath command_GMM_LOMgain_true_gain_constant_only_pi_only_18_Jun_2020}}
\caption{The truth using 2 gridpoints on $[0,1]$ for the gain, 15 on $[-5,5]$ for the forecast error}
\end{figure}


\begin{figure}[h!]
\subfigure[$k^{-1}_t$ as a function of $k^{-1}_{t-1}$ and $fe_{t|t-1}$ given $\hat{\alpha}^{true}$]{\includegraphics[scale=\mySmallFigScale]{\myFigPath command_GMM_LOMgain_true_relationship_19_Jun_2020}}
\hfill
\subfigure[A simulated history of $k^{-1}_t$ given $\hat{\alpha}^{true}$]{\includegraphics[scale=\mySmallFigScale]{\myFigPath command_GMM_LOMgain_true_gain_sim_constant_only_pi_only_19_Jun_2020}}
...
\begin{figure}[h!]
\subfigure[$k^{-1}_t$ as a function of $fe_{t|t-1}$ given $\hat{\alpha}^{true}$]{\includegraphics[scale=\mySmallFigScale]{\myFigPath command_GMM_LOMgain_univariate_alph_true_21_Jun_2020}}
\hfill
\subfigure[A simulated history of $k^{-1}_t$ given $\hat{\alpha}^{true}$]{\includegraphics[scale=\mySmallFigScale]{\myFigPath command_GMM_LOMgain_univariate_true_gain_sim_constant_only_pi_only_21_Jun_2020}}
