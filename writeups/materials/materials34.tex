...
\begin{figure}[h!]
\subfigure[$\hat{\alpha}$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath materials34_acf_data_11_Jun_2020_2D_alphas_opt_23_Jun_2020}}
\hfill
\subfigure[Residuals]{\includegraphics[scale=\myTinyFigScale]{\myFigPath materials34_acf_data_11_Jun_2020_2D_residuals_23_Jun_2020}}
\subfigure[Moments]{\includegraphics[scale=\myTinyFigScale]{\myFigPath materials34_acf_data_11_Jun_2020_2D_moments_23_Jun_2020}}
\hfill
\subfigure[Implied relationship at median estimate]{\includegraphics[scale=\myTinyFigScale]{\myFigPath materials34_acf_data_11_Jun_2020_relationship_at_opt_median_23_Jun_2020}}
...
\begin{figure}[h!]
\subfigure[$k^{-1}_t$ as a function of $k^{-1}_{t-1}$ and $fe_{t|t-1}$ given $\alpha^{true}$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath command_acf_sim_data_true_relationship_21_Jun_2020}}
\hfill
\subfigure[A simulated history of $k^{-1}_t$ given $\alpha^{true}$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath command_acf_sim_data_true_gain_sim_constant_only_pi_only_21_Jun_2020}}
\caption{The truth using 2 gridpoints on $[0,1]$ for the gain, 6 on $[-5,5]$ for the forecast error}
\end{figure}

\begin{figure}[h!]
\subfigure[$\alpha^{true}$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath materials34_2D_alphas_true23_Jun_2020}}
\hfill
\subfigure[$\hat{\alpha}$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath materials34_acf_sim_data_21_Jun_2020_2D_alphas_opt_23_Jun_2020}}
\subfigure[Residuals]{\includegraphics[scale=\myTinyFigScale]{\myFigPath 
materials34_acf_sim_data_21_Jun_2020_2D_residuals_23_Jun_2020}}
\hfill
\subfigure[Moments]{\includegraphics[scale=\myTinyFigScale]{\myFigPath materials34_acf_sim_data_21_Jun_2020_2D_moments_23_Jun_2020}}
\caption{$\hat{\alpha}$ for various random starting points}
\end{figure}
...
\begin{figure}[h!]
\includegraphics[scale=\myTinyFigScale]{\myFigPath command_GMM_LOMgain_univariate_loss_for_indi_alphas_others_at_true23_Jun_2020}
...
\begin{figure}[h!]
\subfigure[$\alpha^{rand1}$]{\includegraphics[scale=\mySmallFigScale]{\myFigPath command_GMM_LOMgain_univariate_loss_for_indi_alphas_others_at_initial24_Jun_2020}}
\hfill
\subfigure[$\alpha^{rand2}$]{\includegraphics[scale=\mySmallFigScale]{\myFigPath command_GMM_LOMgain_univariate_loss_for_indi_alphas_others_at_alph_opt24_Jun_2020}}
