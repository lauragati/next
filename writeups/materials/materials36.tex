...
\begin{figure}[h!]
\subfigure[$\alpha^{true}, \alpha_0, mean(\hat{\alpha}^{top10})$, no additional moments]{\includegraphics[scale=\myTinyFigScale]{\myFigPath command_GMM_LOMgain_univariate_alphas_resnorm_539_08_Jul_2020}}
\hfill
...
\subfigure[$\alpha^{true}, \alpha_0, mean(\hat{\alpha}^{top10})$, convexity moments imposed with weight 10M]{\includegraphics[scale=\myTinyFigScale]{\myFigPath command_GMM_LOMgain_univariate_alphas_resnorm_563_08_Jul_2020}}
\hfill
...
\begin{figure}[h!]
\subfigure[$\hat{\alpha}^{best}$, no additional moments (squared sum of resids = 539)]{\includegraphics[scale=\myTinyFigScale]{\myFigPath command_GMM_LOMgain_univariate_alph_opt_resnorm_539_08_Jul_2020}}
\hfill
\subfigure[$\hat{\alpha}^{best}$, convexity moments imposed with weight 10M (squared sum of resids = 563)]{\includegraphics[scale=\myTinyFigScale]{\myFigPath command_GMM_LOMgain_univariate_alph_opt_resnorm_563_08_Jul_2020}}
\caption{Best estimates for the two cases}
\end{figure}
