...
\begin{figure}[h!]
\subfigure[$mean(\hat{\alpha})=(0.0979;    0.0076;    0.0058;    0.006;    0.0864), \colorbox{yellow}{N=1000} $]{\includegraphics[scale=\myTinyFigScale]{\myFigPath command_GMM_LOMgain_univariate_alph_opt_resnorm_87_10_Jul_2020}}
\hfill
...
\caption{Mean estimated parameters over the cross-section of size $N$, convexity imposed with weight 10M, mean moment not imposed}
\end{figure}
