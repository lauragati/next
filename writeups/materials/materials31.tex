...
The value function problem takes the form
\begin{align*}
...
& \text{s.t.} \\
 ...
 k_t^{-1} & = \rho_k k_{t-1}^{-1}+ \gamma_k(-\kappa\sigma i_t +\Omega_{12}\bar{\pi}_{t-1}  +\Omega_5 s_t-b_1 s_{t-1})^2  \numberthis
\end{align*}
where the parameters $\Omega_i$ are defined in Materials 25, as is $\mathbf{x_t} \equiv (k_t^{-1}, \bar{\pi}_{t-1}, r_t^n, u_t)$.
