...
\title{Materials 42 - More volatile world}
\author{Laura G\'ati} 
\date{\today}
\maketitle
...
\clearpage
\section{Reference figures: autocovariances in real data}

\begin{figure}[h!]
\includegraphics[scale=0.32]{\myFigPath autocovariogram_constant_only_pi_only_N_100_nfe_5femax_2_loss_382_gridspacing_manual_Wdiffs2_100000_Wmid_1000_Nsimulations_scaleW_0_use_expectations_0_use_meas_error_0_command_GMM_LOMgain_univariate_12_Aug_2020_09_16_29}
\caption{Autocovariogram in real data (Fig 16 in Materials 40) (ignore the red and yellow lines)}
\end{figure}


\clearpage
\section{Trying not to punch holes into the loss}
\begin{figure}[h!]
...
\clearpage
\section{Model moments against data moments - varying shock volatilities}

\begin{figure}[h!]
\subfigure[$(\sigma_r, \sigma_u, \sigma_i) = (1,1,1)$]{\includegraphics[scale=0.32]{\myFigPath autocovariogram_N_100_nfe_5_gridspacing_manual_Wdiffs2_100000_Wmid_1000_Nsimulations_command_sigmas_21_Aug_2020_11_10_54}}
\subfigure[$(\sigma_r, \sigma_u, \sigma_i) = (1,8,1)$]{\includegraphics[scale=0.32]{\myFigPath autocovariogram_N_100_nfe_5_gridspacing_manual_Wdiffs2_100000_Wmid_1000_Nsimulations_command_sigmas_21_Aug_2020_11_19_23}}
\caption{}
\end{figure}

\begin{figure}[h!]
\subfigure[$(\sigma_r, \sigma_u, \sigma_i) = (0.1,8,0.1)$ - really indifferent to cost-push and monpol shocks?]{\includegraphics[scale=0.32]{\myFigPath autocovariogram_N_100_nfe_5_gridspacing_manual_Wdiffs2_100000_Wmid_1000_Nsimulations_command_sigmas_21_Aug_2020_11_21_56}}
\subfigure[$(\sigma_r, \sigma_u, \sigma_i) = (1,8,1)$]{\includegraphics[scale=0.32]{\myFigPath placeholder}}
\caption{}
\end{figure}
