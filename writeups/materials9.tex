...
\newpage
\section{More plots of IRFs, mon. pol shock only, cgain and dgain only $\blacktriangleleft$}	

\begin{figure}[h!]
\subfigure[Deceasing gain, $t=5$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath materials9_RIR_y_d_monpol_rho0_psi_pi_1_5_sig_1_dt_5}}
...
\begin{figure}[h!]
\subfigure[Deceasing gain, $t=5$]{\includegraphics[scale=\myTinyFigScale]{\myFigPath materials9_RIR_F_d_monpol_rho0_psi_pi_1_5_sig_1_dt_5}}
...
\begin{figure}[h!]
\subfigure[Deceasing gain, $t=5$]{\includegraphics[scale=\myTinierFigScale]{\myFigPath placeholder}}
\subfigure[Constant gain, $t=5$]{\includegraphics[scale=\myTinierFigScale]{\myFigPath placeholder}}
\subfigure[Decreasing gain, $t=25$]{\includegraphics[scale=\myTinierFigScale]{\myFigPath placeholder}}
\subfigure[Constant gain, $t=25$]{\includegraphics[scale=\myTinierFigScale]{\myFigPath placeholder}}
