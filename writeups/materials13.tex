...
\begin{figure}[h!]
\includegraphics[scale=\mySmallerFigScale]{\myFigPath pil_bet0_96}
...
\begin{figure}[h!]
\includegraphics[scale=\mySmallerFigScale]{\myFigPath command_IRFs_many_learning_RIR_LH_monpol_cgain_gbar_0_145_default_learning_pill_suboptimal_fcst_constant_only}
