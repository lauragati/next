...
\item Learn $h_x$
\begin{figure}[h!]
\includegraphics[scale=\mySmallFigScale]{\myFigPath command_IRFs_many_learning_RIR_LH_monpol_cgain_gbar_0_145_learn_hx_true_baseline_no_info_ass_constant_only}
...
Done a correction for $\hat{\E}\pi_{t+1}$ in TR, now both are stable, but overshooting is still there in both.
