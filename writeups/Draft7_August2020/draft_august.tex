...
% numbers update 30 July 2020

% mean estimated alpha
\def\meanalph{(0.3509;0.1427;0.0180;0.0005;0.0204;0.1406;0.3411)}
% for 1% fe, you get a gain of
\def\oneppFEgives{0.02 }
% for 1% fe, you get a change in pibar of
\def\betPibFe{0.0877 } % analyze_opt_policy.m
...
% di/dpibar
% analyze_opt_policy. Mean(alph) = (0.3509;0.1427;0.0180;0.0005;0.0204;0.1406;0.3411)
\def\fignameDiDpibar{analyze_opt_policy_ip29_Jul_2020}

% Observables in PEA for TR
% command_pea_approx_main with knowTR=1, otherwise explode. Mean(alph) = (0.3509;0.1427;0.0180;0.0005;0.0204;0.1406;0.3411)
\def\fignamePEAobsTR{implement_anchTC_obs_TR_approx29_Jul_2020}
% Observables in PEA for anchoring
% Materials 37 Fig 16. Mean(alph) = (0.3509;0.1427;0.0180;0.0005;0.0204;0.1406;0.3411)
\def\fignamePEAobsAnch{implement_anchTC_obs_approx17_Jul_2020}

% Central bank loss as a function of psi_pi in RE vs. anchoring
% plot_sim_loss_approx.m. Mean(alph) = (0.3509;0.1427;0.0180;0.0005;0.0204;0.1406;0.3411)
...
% Retired: CB loss RE:\def\fignameCBlossRE{plot_sim_loss_pretty_loss_RE_again_critCUSUM_constant_only_params_psi_pi_1_5_psi_x_0_gbar_0_145_thetbar_16_thettilde_2_5_kap_0_8_lamx_0_lami_0_2020_06_05}
% Retired: CB loss anchoring: \def\fignameCBlossAnch{plot_sim_loss_pretty_loss_again_critCUSUM_constant_only_T_400_N_100_burnin_0_params_psi_pi_1_5_psi_x_0_gbar_0_145_thetbar_16_thettilde_2_5_kap_0_8_lamx_0_lami_0_date_2020_06_05}
...
% materials 37, Fig 14. Mean(alph) = (0.3509;0.1427;0.0180;0.0005;0.0204;0.1406;0.3411)
\def\fignamePEAvsVFIfirstX{compare_value_pea_results_approx_value_outputs_approx17_Jul_2020_14_27_00_pea_outputs_approx17_Jul_2020_11_40_09_pretty}
...
\subfigure[Optimal policy]{\includegraphics[scale=0.24]{\myFigPath \fignamePEAobsAnch}}
...
\begin{tabular}{ c | c | c }
 ...
 Baseline ($\lambda_x =0.05, \lambda_i =0$)  & $1.8581$  & 1.034 \\  \hline
...
\begin{tabular}{ c | c | c }
 & RE & Anchoring \\  \hline
  Taylor rule with $\psi_{\pi} =1.5, \psi_{x} = 0$     & 46.7290  & 55.3100 \\  \hline
 RE-optimal* Taylor rule with $\psi_{\pi} =1.8581, \psi_{x} = 0$   &46.5180  &  61.3064 \\  \hline
 Anchoring-optimal* Taylor rule with $\psi_{\pi} =1.034, \psi_{x} = 0$   & 47.7175  & 48.2510\\  \hline
 Optimal policy & na.  & $\approx 0.74$ \footnote{An estimate based on a single evaluation of the loss function for a PEA-optimal simulation.} \\  \hline
\end{tabular}     
