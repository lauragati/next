...
Quantitatively, the estimation reveals that already forecast errors above \ppFEunanchors percentage point are sufficient to unanchor expectations, inducing long-run inflation expectations to drift by \betPibFe pp. Thus, for a negative forecast error of \ppFEunanchors pp, the optimal policy involves lowering the interest rate by \ppMoveFFR pp.
