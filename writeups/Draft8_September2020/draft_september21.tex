...
Fed Chairman Jerome Powell's words echo the common sentiment among central bankers. Indeed, there is broad consensus among policymakers that anchoring inflation expectations is ``at the heart'' of monetary policy.\footnote{Jerome Powell, ``Challenges for Monetary Policy,''  August 23, 2019, Jackson Hole.} As Powell emphasizes, expectations are anchored when long-run expectations do not fluctuate systematically with short-run inflation surprises.\footnote{By ``expectations of long-run inflation'' I mean the private sector's expectation of where inflation will be on average over a longer period in the future. Therefore I also refer to this as ``expected mean inflation.''} The passage thus suggests that the Fed worries about anchoring inflation expectations to the target in order to avoid the adverse cycle of self-enforcing movements in expectations.
...
Arguably the leading candidate of nonrational expectation formation is the diagnostic expectations approach, advocated by \cite{bordalo2018over} and \cite{bordalo2018diagnostic}. The reason the anchoring expectation formation entertained here is better suited to my purpose is that whether it predicts over- or underreaction to news is not static, but time-varying. This allows my model to both capture anchoring, periods where long-run expectations appear detached from fundamentals, as well as episodes of very sensitive reaction in expectations, that is, unanchoring.
