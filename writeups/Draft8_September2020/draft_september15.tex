...
% SPF long-run-e
\def\fignameSPFEPi{lr_epi_in_data_command_anchoring_in_data_03_Sep_2020_09_24_50}
...
Quantitatively, the estimation reveals that already forecast errors above \ppFEunanchors percentage points are sufficient to unanchor expectations. Moreover, the optimal policy implies that if long-run expectations drift down by 0.1 pp, the optimal response is to lower the interest rate by \movei pp.
