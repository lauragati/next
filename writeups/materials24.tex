...
\hfill
\subfigure[Same as (a), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implement_anchTC_i_init_rand}}
...
\hfill
\subfigure[Same as (c), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implement_anchTC_xi_init_rand}}
...
\hfill
\subfigure[Same as (e), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implement_anchTC__pixi_init_rand}}
\caption{Simulation using Taylor rule against exogenous sequences that minimize equation residuals including the simple anchoring target criterion}
\end{figure}
