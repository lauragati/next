...
\newpage
\section{FSOLVE}
\subsection{FSOLVE: Implementing the Taylor-rule w/o using it}

\vspace{-0.2cm}

\begin{figure}[h!]
%\subfigure[Inputs: $i$, residual eq.: TR; initialized at TR]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implementTR_i_init_TR}}
%\hfill
%\subfigure[Same as (a), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implementTR_i_init_rand}}
%\subfigure[Inputs: $x,i$, residual eq.: A9, TR; initialized at TR]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implementTR_xi_init_TR}}
%\hfill
%\subfigure[Same as (c), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implementTR_xi_init_rand}}
\subfigure[Inputs: $\pi,x,i$, residual eq. A9, A10, TR;  initialized at TR]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implementTR__pixi_init_TR}}
\hfill
\subfigure[Same as (e), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implementTR__pixi_init_rand}}
\caption{Simulation using Taylor rule against exogenous sequences that minimize equation residuals}
\end{figure}


%\newpage
%\subsection{FSOLVE: Implementing the RE-discretion target criterion}
%
%\vspace{-0.2cm}
%
%\begin{figure}[h!]
%\subfigure[Inputs: $i$, residual eq.: TC.]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implementRE_TC_i_init_TR}}
%\hfill
%\subfigure[Same as (a), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implementRE_TC_i_init_rand}}
%\subfigure[Inputs: $x,i$, residual eq.: A9, TC.]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implementRE_TC_xi_init_TR}}
%\hfill
%\subfigure[Same as (c), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implementRE_TC_xi_init_rand}}
%\subfigure[Inputs: $\pi,x,i$, residual eq. A9, A10, TC.]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implementRE_TC__pixi_init_TR}}
%\hfill
%\subfigure[Same as (e), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implementRE_TC__pixi_init_rand}}
...
%
%\newpage
%\subsection{FSOLVE: Implementing the simple anchoring target criterion}
%
%\vspace{-0.2cm}
%
%\begin{figure}[h!]
%\subfigure[Inputs: $i$, residual eq.: TC.]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implement_anchTC_i_init_TR}}
%\hfill
%\subfigure[Same as (a), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implement_anchTC_i_init_rand}}
%\subfigure[Inputs: $x,i$, residual eq.: A9, TC.]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implement_anchTC_xi_init_TR}}
%\hfill
%\subfigure[Same as (c), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implement_anchTC_xi_init_rand}}
%\subfigure[Inputs: $\pi,x,i$, residual eq. A9, A10, TC.]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implement_anchTC__pixi_init_TR}}
%\hfill
%\subfigure[Same as (e), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_fsolve_implement_anchTC__pixi_init_rand}}
...
\begin{figure}[h!]
%\subfigure[Inputs: $i$, residual eq.: TR; initialized at TR]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implementTR_i_init_TR}}
%\hfill
%\subfigure[Same as (a), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implementTR_i_init_rand}}
%\subfigure[Inputs: $x,i$, residual eq.: A9, TR; initialized at TR]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implementTR_xi_init_TR}}
%\hfill
%\subfigure[Same as (c), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implementTR_xi_init_rand}}
\subfigure[Inputs: $\pi,x,i$, residual eq. A9, A10, TR;  initialized at TR]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implementTR__pixi_init_TR}}
\hfill
\subfigure[Same as (e), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implementTR__pixi_init_rand}}
\caption{Simulation using Taylor rule against exogenous sequences that minimize equation residuals}
\end{figure}
...
\begin{figure}[h!]
%\subfigure[Inputs: $i$, residual eq.: TC.]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implementRE_TC_i_init_TR}}
%\hfill
%\subfigure[Same as (a), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implementRE_TC_i_init_rand}}
%\subfigure[Inputs: $x,i$, residual eq.: A9, TC.]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implementRE_TC_xi_init_TR}}
%\hfill
%\subfigure[Same as (c), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implementRE_TC_xi_init_rand}}
\subfigure[Inputs: $\pi,x,i$, residual eq. A9, A10, TC.]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implementRE_TC__pixi_init_TR}}
\hfill
\subfigure[Same as (e), initialized at random sequence(s)]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implementRE_TC__pixi_init_rand}}
\caption{Simulation using Taylor rule against exogenous sequences that minimize equation residuals including RE discretion target criterion}
\end{figure}
...
%\newpage
\subsection{FMINCON: Implementing the simple anchoring target criterion}

\vspace{-0.2cm}

\begin{figure}[h!]
%%\subfigure[Inputs: $i$, residual eq.: TC.]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implement_anchTC_i_init_TR}}
%%\hfill
%\subfigure[Inputs: $i$, residual eq.: TC., initialized at random sequence(s)]{\includegraphics[scale=0.178]{\myFigPath command_sim_given_seq_implement_anchTC_i_init_rand}}
%%\subfigure[Inputs: $x,i$, residual eq.: A9, TC.]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implement_anchTC_xi_init_TR}}
\hfill
\subfigure[Inputs: $x,i$, residual eq.: A9, TC., initialized at random sequence(s)]{\includegraphics[scale=0.17]{\myFigPath command_sim_given_seq_implement_anchTC_xi_init_rand}}
%\subfigure[Inputs: $\pi,x,i$, residual eq. A9, A10, TC.]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_implement_anchTC__pixi_init_TR}}
%\hfill
\subfigure[Inputs: $\pi,x,i$, residual eq. A9, A10, TC., initialized at random sequence(s)]{\includegraphics[scale=0.17]{\myFigPath command_sim_given_seq_implement_anchTC__pixi_init_rand}}
\caption{Simulation using Taylor rule against exogenous sequences that minimize equation residuals including the simple anchoring target criterion}
\end{figure}
