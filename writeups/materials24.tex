...
\begin{figure}[h!]
\subfigure[Inputs: $i$, residual eq.: none]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seqi}}
\subfigure[Inputs: $x,i$, residual eq.: A9.]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seqxi}}
\subfigure[Inputs: $\pi,x,i$, residual eq. A9, A10.]{\includegraphics[scale=\myAdjustableFigScale]{\myFigPath command_sim_given_seq_pixi}}
...
\section{Tried to derive a target criterion for the case when the anchoring function is specified in terms of changes in the gain}\label{target_crit_changes}
\begin{equation}
