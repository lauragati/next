...
\caption{Simulation using Taylor rule against exogenous sequences that minimize equation residuals includng RE discretion target criterion, initialized at Taylor-rule sequences}
\end{figure}

I don't see a huge difference between imposing the TC or not, especially not if I initialize at the Taylor-rule sequences.
